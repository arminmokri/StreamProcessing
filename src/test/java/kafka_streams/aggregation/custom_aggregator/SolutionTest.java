package kafka_streams.aggregation.custom_aggregator;
...
public class SolutionTest {
    ...
    public void testDefaultCase() {
        ...
        sendInput(INPUT_TOPIC, "A", "banana", null);
        sendInput(INPUT_TOPIC, "A", "orange", null);
        sendInput(INPUT_TOPIC, "B", "mango", null);
        sendInput(INPUT_TOPIC, "B", "kiwi", null);
        ...
        assertEquals("apple-banana-orange", getValue(results, "A"));
        assertEquals("mango-kiwi", getValue(results, "B"));
    }
