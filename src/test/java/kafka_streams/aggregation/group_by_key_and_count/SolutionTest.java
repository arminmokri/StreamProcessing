package kafka_streams.aggregation.group_by_key_and_count;
...
public class SolutionTest {
    ...
    public void testDefaultCase() {
        sendInput(INPUT_TOPIC, "A", "apple", null);
        sendInput(INPUT_TOPIC, "B", "banana", null);
        sendInput(INPUT_TOPIC, "A", "avocado", null);
        sendInput(INPUT_TOPIC, "A", "apricot", null);
        sendInput(INPUT_TOPIC, "B", "blueberry", null);

        List<ConsumerRecord<String, Long>> results = readOutput(OUTPUT_TOPIC, 5, 5_000);
    ...
    private Long getValue(List<ConsumerRecord<String, Long>> results, String key) {
