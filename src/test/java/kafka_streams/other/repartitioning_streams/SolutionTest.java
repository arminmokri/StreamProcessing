...
public class SolutionTest {
    ...
    public void testDefaultCase() {
        ...
        Solution.Purchase purchase1 = new Solution.Purchase("Alice", "cookie", 20);
        Solution.Purchase purchase2 = new Solution.Purchase("Bob", "hamburger", 35);
        Solution.Purchase purchase3 = new Solution.Purchase("Bob", "coffee", 35);
        ...
        List<ConsumerRecord<String, Integer>> results = readOutput(OUTPUT_TOPIC, 2, 5_000);
        ...
        assertEquals(20, getValue(results, "Alice"));
    ...
    private List<ConsumerRecord<String, Integer>> readOutput(String topic, int expectedKeys, long timeoutMillis) {
        ...
        List<ConsumerRecord<String, Integer>> results = new LinkedList<>();
